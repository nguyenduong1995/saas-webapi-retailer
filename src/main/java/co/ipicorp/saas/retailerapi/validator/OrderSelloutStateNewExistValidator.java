...
@Component
public class OrderSelloutStateNewExistValidator extends AbstractFormValidator {
	...
	private boolean validateById(SelloutIdForm selloutIdForm, Errors errors) {
		...
		if ( selloutIdForm.getSelloutId() != null ) {
	    	...
	    	if ( !orderSellout.getOrderStatus().equals(OrderSelloutStatus.NEW.toString())){
	    		errors.reject(ErrorCode.APP_2105_ORDER_SELLOUT_STATE_NOT_EXACTLY,
						new Object[] { "Order Sellout Id", selloutIdForm.getSelloutId(), OrderSelloutStatus.NEW.toString() },
