...
public class AmountItemRemainValidator extends AbstractFormValidator {
     ...
     */
    private boolean validate(Errors errors, OrderSellout orderSellout, int productId, int productVariationId, int amountInOrder, RetailerWarehouseTotalItem retailerWarehouseTotalItem) {
        ...
        Integer amount = retailerWarehouseTotalItem.getAmountAvailable() - amountInOrder;
        if (amount < 0) {
            errors.reject(ErrorCode.APP_2104_RETAILER_WAREHOUSE_AMOUNT_AVAILABLE_NOT_ENOUGH, new Object[] { "Product Variation ID", productVariationId, Math.abs(amount) },
